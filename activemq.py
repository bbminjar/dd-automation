...
def get_all_input_fields_and_add_to_data_dog(customer_name, api_key, app_key,support_mail, access_key, secret_key, slack_channels, customer_email_id, queue_consumer_count, queue_producer_count, queue_memory_pct, queue_size, alerts_list):
    ...
    if "activemq" in alerts_list:
            ...
            api.Monitor.create(type="metric alert",
                       ...
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_30m):avg:activemq.queue.consumer_count{*} by {host,name,region} >" + str(queue_consumer_count),
                       ...
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_1h):avg:activemq.queue.consumer_count{*} by {host,name,region} >" + str(queue_consumer_count),
...
#Producer_Count
            ...
            api.Monitor.create(type="metric alert",
                       ...
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_30m):avg:activemq.queue.producer_count{*} by {host,name,region} >" + str(queue_producer_count),
                       ...
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_1h):avg:activemq.queue.producer_count{*} by {host,name,region} >" + str(queue_producer_count),
...
#queue.memory_pct
            ...
            api.Monitor.create(type="metric alert",
                       ...
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_30m):avg:activemq.queue.memory_pct{*} by {host,name,region} >" + str(queue_memory_pct),
                       name="[Escalation-TL]" + " - " + "["+str(customer_name)+"]" + " - " + "JVM heap memory is high",
                       message="Team,JVM heap memory is high. Please take a look into this. @cloudops-business@minjar.com ",
                       tags=tags,
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_1h):avg:activemq.queue.memory_pct{*} by {host,name,region} >" + str(queue_memory_pct),
                       name="[Escalation]" + " - " + "["+str(customer_name)+"]" + " - " + "JVM heap memory is high",
                       message="Team,JVM heap memory is high. Please take a look into this. @cloudops-business@minjar.com ",
                       tags=tags,
                       options=options),
#queue_size
            ...
            api.Monitor.create(type="metric alert",
                       ...
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_30m):avg:activemq.queue.size{*} by {host,name,region} >" + str(queue_size),
                       name="[Escalation-TL]" + " - " + "["+str(customer_name)+"]" + " - " + "JVM heap memory is high",
                       message="Team,JVM heap memory is high. Please take a look into this. @cloudops-business@minjar.com ",
                       tags=tags,
                       options=options),
            api.Monitor.create(type="metric alert",
                       query="min(last_1h):avg:activemq.queue.size{*} by {host,name,region} >" + str(queue_size),
                       name="[Escalation]" + " - " + "["+str(customer_name)+"]" + " - " + "JVM heap memory is high",
                       message="Team,JVM heap memory is high. Please take a look into this. @cloudops-business@minjar.com ",
                       tags=tags,
                       options=options),
