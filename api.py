...
def handle_data():
    try:
        ...
        if input_form["customer_name"] is None or input_form["api_key"] is None or input_form["app_key"] is None or input_form["access_key"] is None or input_form["secret_key"] is None or input_form["email_id"] is None or input_form["slack_channels"] is None or input_form["customer_email"] is None or input_form["cpu_threshold"] is None or input_form["disk_threshold"] is None or input_form["memory_threshold"] is None or input_form["elb_httpcode_backend_4xx"] is None or input_form["elb_httpcode_backend_5xx"] is None or input_form["rds_cpuutilization"] is None or input_form["rds_free_storage_space"] is None or input_form["check_list"] is None or input_form["apache_net_hits"] is None or input_form["tomcat_threads_max"] is None or input_form["tomcat_request_count"] is None or input_form["thread_count"] is None or input_form["heap_memory"] is None or input_form["performance_slow_queries"] is None or input_form["innodb_row_lock_time"] is None or input_form["innodb_row_lock_waits"] is None or input_form["postgresql_connections"] is None or input_form["postgresql_locks"] is None or input_form["connections_current"] is None or input_form["mem_resident"] is None or input_form["mem_virtual"] is None or input_form["queue_consumer_count"] is None or input_form["queue_producer_count"] is None or input_form["queue_memory_pct"] is None or input_form["queue_size"] is None or len(input_form.getlist("check_list")) == 0:
            ...
            is_created = elb.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"], input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form['elb_httpcode_backend_4xx'], input_form["elb_httpcode_backend_5xx"], input_form.getlist('check_list'))
            is_created = rds.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"] , input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form["rds_cpuutilization"], input_form["rds_free_storage_space"], input_form.getlist('check_list'))
            # is_created = apache_tomcat.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"] , input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form["apache_net_hits"], input_form["tomcat_threads_max"], input_form["tomcat_request_count"], input_form.getlist('check_list'))
            # is_created = java.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"] , input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form["thread_count"], input_form["heap_memory"],input_form.getlist('check_list'))
            # is_created = activemq.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"] , input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form["queue_consumer_count"], input_form["queue_producer_count"], input_form["queue_memory_pct"], input_form["queue_size"], input_form.getlist('check_list'))
            # is_created = nginx.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"] , input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form["connections"] ,input_form.getlist('check_list'))
            ...
            # is_created = mongodb.get_all_input_fields_and_add_to_data_dog(input_form["customer_name"] , input_form["api_key"] , input_form["app_key"] , input_form["access_key"] , input_form["secret_key"] , input_form["email_id"] , input_form["slack_channels"] , input_form["customer_email"], input_form["connections_current"], input_form["mem_resident"], input_form["mem_virtual"], input_form.getlist('check_list'))
